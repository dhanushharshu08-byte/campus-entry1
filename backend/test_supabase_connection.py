...
class TestSupabaseConnection(unittest.TestCase):
    ...
    def test_04_config_class_integration(self):
        ...
        self.assertEqual(Config.SUPABASE_PROJECT_REF, "jxjfyrodyaellwnhhauy")
        self.assertEqual(Config.SUPABASE_URL, "https://jxjfyrodyaellwnhhauy.supabase.co")
        self.assertTrue(len(Config.SUPABASE_ANON_KEY) > 20)
        self.assertTrue(len(Config.SUPABASE_SERVICE_ROLE_KEY) > 20)
